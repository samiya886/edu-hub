...
const MOBILE_OPTIMIZATION_CSS = `
    @media (max-width: 640px) {
      ...
      .eduhub-mobile-menu-link {
        ...
        border: 1px solid rgba(10, 74, 68, 0.10) !important;
        border-radius: 12px !important;
        background: #ffffff !important;
...
(function () {
  ...
  function createMenuButton(id, label, className, onPress, parent) {
  ...
  function installExactMobileMenu() {
    ...
    if (loggedIn) {
      menuItems.push({ id: 'eduhub-menu-logout', label: 'Logout', action: logoutUser });
    } else {
      menuItems.push({ id: 'eduhub-menu-signin', label: 'Sign In', path: '/auth' });
      menuItems.push({ id: 'eduhub-menu-signup', label: 'Sign Up', path: '/auth?mode=signup' });
    }
