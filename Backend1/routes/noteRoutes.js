...
router.post("/", authenticate, authorize("admin", "teacher", "student"), uploadPdf.single("file"), createNote);
router.put("/:id", authenticate, authorize("admin", "teacher", "student"), uploadPdf.single("file"), updateNote);
