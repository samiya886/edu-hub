...
router.post("/", authenticate, authorize("admin", "teacher", "student"), uploadFile.single("file"), createPaper);
router.put("/:id", authenticate, authorize("admin", "teacher", "student"), uploadFile.single("file"), updatePaper);
