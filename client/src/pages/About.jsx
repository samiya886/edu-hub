    ...
    <div className="bg-white min-h-screen">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={gridReveal} className="mobile-carousel mobile-scroll-track md:grid-cols-4 md:gap-8">
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto overflow-hidden">
        ...
        <motion.div
          ...
          className="mobile-carousel mobile-scroll-track md:grid-cols-3 md:gap-12"
        >
          {values.map((value) => (
            <motion.div
              key={value.title}
