    ...
    <div className="bg-white min-h-screen pb-20">
      <section className="bg-[#0a4a44] pt-32 pb-24 px-6 rounded-b-[60px] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto lg:mx-0 group flex flex-col gap-3 sm:relative sm:block">
              <div className="relative">
                <Search className="pointer-events-none absolute left-5 top-1/2 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-[#ff9f00]" size={20} />
                <input
                  type="text"
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12 bg-white/90 backdrop-blur border border-gray-100 rounded-[32px] p-4 md:p-5 shadow-[0_20px_60px_-35px_rgba(10,74,68,0.35)] sticky top-24 z-20">
          <div className="mobile-pill-track w-full md:w-auto">
        ...
        {isLoading ? (
          ...
          <motion.div variants={gridReveal} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.08 }} className="mobile-carousel mobile-scroll-track md:grid-cols-2 lg:grid-cols-4 md:gap-6">
