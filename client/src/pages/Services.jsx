  ...
  return (
    <div className="bg-white min-h-screen pb-20">
          ...
          {services.map((service, idx) => (
            ...
            >
              ...
              <div className="flex-1 relative">
                <div className="relative z-10 rounded-[60px] overflow-hidden border-[12px] border-gray-50 shadow-2xl">
                   <img src={service.image} alt={service.title} className="w-full h-[450px] object-cover" />
                </div>
                {/* Floating Stat Card */}
                <div className="absolute -bottom-6 -right-6 lg:-right-10 bg-white p-6 rounded-[32px] shadow-2xl z-20 flex items-center gap-4 border border-gray-50">
                  <div className={`p-3 rounded-2xl ${service.color}`}>
                     <Download size={24} />
                  </div>
                  <div>
                    <p className="text-xl font-black text-[#0a4a44]">{service.stats}</p>
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">From Database</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1">
                <span className="text-[#ff9f00] font-black uppercase tracking-widest text-sm mb-4 block">{service.tag}</span>
                <h2 className="text-4xl font-black text-[#0a4a44] mb-6 leading-tight">
                  {service.title}
                </h2>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-10">
                  {service.features.map(feat => (
                    <div key={feat} className="flex items-center gap-3 text-gray-600 font-bold text-sm">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link to={service.path} className="bg-[#0a4a44] text-white px-10 py-4 rounded-2xl font-bold flex items-center gap-2 hover:bg-[#083a35] transition shadow-xl shadow-teal-100">
                    Explore Now <ArrowRight size={20} />
                  </Link>
                  <Link to={service.samplePath} className="bg-gray-50 text-[#0a4a44] px-8 py-4 rounded-2xl font-bold hover:bg-gray-100 transition border border-gray-200">
                    View Samples
                  </Link>
                </div>
              </div>
      ...
      >
        ...
        <motion.div variants={gridReveal} className="relative z-10 mx-auto grid max-w-7xl grid-cols-2 gap-5 px-6 md:grid-cols-4 lg:gap-8">
           {[
      ...
      >
        ...
        {isLoading ? (
          ...
          <motion.div variants={gridReveal} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.12 }} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
