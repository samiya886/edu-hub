      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
              ...
              >
                ...
                <div className="px-4 pb-4 relative z-10">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-8">
                    {[
                      { icon: <BookOpen size={14}/>, label: "Notes", val: 0 },
                      { icon: <FileText size={14}/>, label: "Papers", val: 0 },
                  ...
                  <button className="w-full bg-[#0a4a44] text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-[#ff9f00] transition-all shadow-lg shadow-teal-100">
        ...
        {filteredSubjects.length === 0 && (
          <div className="text-center py-32">
             ...
             <p className="text-gray-400 mb-8">{error || 'Select a department, course, and semester to load matching subjects from the backend.'}</p>
