  ...
  >
    ...
    <div className="eduhub-resource-actions mt-auto grid grid-cols-3 gap-3 pt-2">
      ...
      <button
        ...
        disabled={!canManage}
        className="eduhub-resource-action eduhub-resource-action-edit flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-50 px-3 py-2.5 text-sm font-black text-[#0a4a44] shadow-sm transition hover:bg-[#0a4a44] hover:text-white disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-300"
      >
        <Edit2 size={14} /> Edit
      </button>
      <button
        ...
        disabled={!canManage}
        className="eduhub-resource-action eduhub-resource-action-delete flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-red-50 px-3 py-2.5 text-sm font-black text-red-500 shadow-sm transition hover:bg-red-500 hover:text-white disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-300"
      >
