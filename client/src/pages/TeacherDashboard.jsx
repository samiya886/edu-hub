  ...
  >
    ...
    <div className="eduhub-resource-actions mt-auto grid grid-cols-3 gap-2 pt-1">
      ...
      <button
        ...
        disabled={!canManage}
        className="eduhub-resource-action eduhub-resource-action-edit flex min-h-9 items-center justify-center gap-1.5 rounded-xl bg-emerald-50 px-2.5 py-2 text-xs font-black text-[#0a4a44] shadow-sm transition hover:bg-[#0a4a44] hover:text-white disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-300"
      >
        <Edit2 size={14} /> Edit
      </button>
      <button
        ...
        disabled={!canManage}
        className="eduhub-resource-action eduhub-resource-action-delete flex min-h-9 items-center justify-center gap-1.5 rounded-xl bg-red-50 px-2.5 py-2 text-xs font-black text-red-500 shadow-sm transition hover:bg-red-500 hover:text-white disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-300"
      >
